...
const (
	...
	ErrSSOCredentialInvalid = 40109 // 单点登录共享凭据无效
	ErrSSOHandoffInvalid    = 40110 // 单点登录交接码无效或已过期
	ErrSSOUserUnavailable   = 40111 // 单点登录对应用户不存在或不可用
	...
	ErrSSOSourceDenied     = 40304 // 单点登录请求来源不在白名单
