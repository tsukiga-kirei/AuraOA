...
// IsEmbedTrigger 是否为 OA 嵌入触发。
func IsEmbedTrigger(trigger string) bool {
	return trigger == AuditTriggerEmbedAuto || trigger == AuditTriggerEmbedManual
}
...
type AuditProcessSnapshot struct {
	...
	Channel          string         `gorm:"size:20;not null;default:workbench" json:"channel"`
