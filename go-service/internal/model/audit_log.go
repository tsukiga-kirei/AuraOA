...
// WorkbenchTriggerSources 审核工作台侧 trigger_source 列表。
func WorkbenchTriggerSources() []string {
	return []string{AuditTriggerWorkbenchManual, AuditTriggerWorkbenchBatch, AuditTriggerCronScheduled}
}

// EmbedTriggerSources OA 嵌入侧 trigger_source 列表。
func EmbedTriggerSources() []string {
	return []string{AuditTriggerEmbedAuto, AuditTriggerEmbedManual}
}
