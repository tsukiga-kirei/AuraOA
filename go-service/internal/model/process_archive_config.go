...
type ProcessArchiveConfig struct {
	...
	AccessControl    datatypes.JSON `gorm:"type:jsonb;not null;default:'{}'" json:"access_control"`            // 访问控制（all/roles/members/departments）
...
// AccessControlData 访问控制配置（审核工作台与归档复盘共用）。
